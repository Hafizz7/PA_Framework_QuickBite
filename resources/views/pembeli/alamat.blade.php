        ...
        <div class="w-full">
            <div class="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2">
                ...
                <form action="{{ route('pembeli.pushAlamat') }}" method="post" class="w-full flex flex-col items-start">
                    ...
                    <button class="block w-full bg-blue-500 text-white font-bold p-4 rounded-lg mt-7" onclick="return confirm('Apakah Anda yakin ingin melakukan pembelian ini?');">Submit</button>
