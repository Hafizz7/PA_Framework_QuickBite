<div class="fixed top-[10%] end-6 bg-[#F9FFF9] h-[80%] mt-1 w-[34%] hidden sm:block shadow-xl rounded-xl pb-2">
    ...
    <div class="absolute bottom-0 w-full px-4 py-2 h-[18%] mt-auto bg-[#EEEEEE] shadow-inner">
        <div class="flex flex-row py-1">
            <h1>Total</h1>
            <h1 class="ml-auto text-2xl" id="grandTotalAmount">{{ $grandTotal }}</h1>
        </div>
        <a href="{{route('pembeli.getalamatkuyyyy')}}">
