            ...
            <div class="h-auto w-full  flex items-start flex-wrap justify-start">
                ...
                <div class=" w-full mx-16 my-2 flex flex-wrap bg-[#E6F9D3] rounded-xl justify-start">
                    @foreach ($makanansss->where('id_menu', $mnu->id) as $mkn)
                        ...
                        <div class="max-w-xs mx-auto wrap bg-[rgb(211,242,178)] rounded-xl overflow-hidden md:max-w-xs my-4 shadow-lg">
                            <img class="h-48 w-full object-cover" src="{{ asset('images/makanan/' . $mkn->gambar) }}" alt="Makanan Image">
                            <div class="p-6">
                                <div class="flex items-baseline">
                                    <span class="inline-block bg-[#84B74E] text-white text-xs uppercase font-semibold tracking-wide p-1 rounded-full">#Makanan</span>
                                </div>
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('pembeli.addKeranjangg', $mkn->id) }}" class="bg-[#84B74E] hover:bg-opacity-90 text-white font-bold py-2 px-4 rounded">
                                        Tambah ke Keranjang
                                    </a>
                                </div>
                            </div>
